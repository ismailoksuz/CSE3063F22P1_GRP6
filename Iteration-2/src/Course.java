...
public abstract class Course {
    ...
    public void setCourseSchedule(Schedule courseSchedule) {
        ...
        /*
         * log.info(this.getCourseName() + ": Course schedule changed." + "(" + "New: "
         * + courseSchedule.toString() + ")");
         */
    }
...
/*
 * public Course(String courseName, String courseCode, int courseCredit, int
 * courseDay, String courseHour, int quota) {
 * this.courseName = courseName;
 * this.courseCode = courseCode;
 * this.courseCredit = courseCredit;
 * this.courseSchedule = new Schedule(courseDay, courseHour);
 ...
 * }
 * 
 * public void setStudentsFailedCredits(ArrayList<Student>
 * studentsFailedCredits) {
 ...
 * }
 * 
 * public void setStudentsCollisionProblem(ArrayList<Student>
 * studentsCollisionProblem) {
